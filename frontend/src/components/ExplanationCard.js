          ...
          <>
            ...
            <div className="bg-green-50 border-l-8 border-green-600 rounded-2xl p-8 mt-10 shadow-lg">
              ...
              <ul className="text-lg text-green-800 space-y-3 list-disc list-inside">
                ...
                <li>Compare charges at <a href="https://www.fairhealthconsumer.org" target="_blank" rel="noopener noreferrer" className="underline font-bold">FairHealthConsumer.org</a> — it's free and shows average costs in your area</li>
