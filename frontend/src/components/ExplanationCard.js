...
export default function ExplanationCard({ result, onUpgrade, onUseSample }) {
  ...
  // Professional PDF Generation (unchanged – already great)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 py-8 px-4 sm:py-12 sm:px-6 lg:px-12">
      <div className="max-w-5xl mx-auto">
            ...
            {[
              ...
              >
                ...
                <div className="relative p-1">
                  <div className="bg-white/10 backdrop-blur rounded-t-2xl sm:rounded-t-3xl px-4 sm:px-6 py-2 sm:py-3">
        ...
        {/* Accordion Sections - Mobile Friendly Spacing */}
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="rounded-2xl backdrop-blur-2xl bg-white/5 border border-white/10 shadow-2xl overflow-hidden">
            ...
            >
              <span className="flex items-center gap-3 sm:gap-4">
                <span className="text-3xl sm:text-4xl">✅</span> What We Found
              </span>
          ...
          {isPaid && mainData?.redFlags?.length > 0 && (
            <div className="rounded-2xl backdrop-blur-2xl bg-white/5 border border-white/10 shadow-2xl overflow-hidden">
              ...
              >
                <span className="flex items-center gap-3 sm:gap-4">
                  <span className="text-3xl sm:text-4xl">⚠️</span> Potential Issues Detected
                </span>
          ...
          <div className="rounded-2xl backdrop-blur-2xl bg-white/5 border border-white/10 shadow-2xl overflow-hidden">
            ...
            >
              <span className="flex items-center gap-3 sm:gap-4">
                <span className="text-3xl sm:text-4xl">🎯</span> Recommended Next Steps
              </span>
