...
export default function UpgradeModal({ onClose, stripePromise }) {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "$9.99/mo",
      features: ["Everything + unlimited bills", "Priority support", "Cancel anytime"],
      popular: true,
    },
    {
      plan: "lifetime",
      ...
      price: "$69.99",
      features: ["One payment forever", "All future features", "Best value"],
      popular: false,
    },
  ];
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <motion.div
        ...
        className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-5xl w-full max-h-screen overflow-y-auto relative"
      >
        <button
          onClick={onClose}
        ...
        <div className="p-12 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-blue-900 dark:text-white mb-8">
            Unlock Full Access
          </h2>
            ...
            {plans.map((p) => (
              <motion.div
                ...
                className={`rounded-3xl p-10 border-4 ${
                  p.popular ? "border-purple-500 shadow-2xl" : "border-gray-300"
                } relative`}
              >
                {p.popular && (
                ...
                <p className="text-5xl font-black text-blue-900 dark:text-white mb-8">
                  {p.price}
                </p>
          ...
          <button
            onClick={onClose}
            className="mt-12 text-gray-500 hover:text-gray-700 text-lg"
          >
            Maybe later
          </button>
        </div>
